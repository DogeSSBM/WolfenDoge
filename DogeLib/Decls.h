...
void drawPixel(const uint, const uint);
void drawPixelCoord(const Coord);
void drawLine(const uint, const uint, const uint, const uint);
void drawLineCoords(const Coord, const Coord);
void drawLineCoordPair(const CoordPair);
void drawHLine(const uint, const uint, int);
void drawVLine(const uint, const uint, int);
void drawRect(const uint, const uint, const uint, const uint);
void drawRectCentered(const uint, const uint, const uint, const uint);
void fillRect(const uint, const uint, const uint, const uint);
void fillRectCentered(const uint, const uint, const uint, const uint);
...
void drawSquareCoord(const Coord, const uint);
void drawSquare(const uint, const uint, const uint);
void fillSquare(const uint, const uint, const uint);
void fillSquareResize(const uint, const uint, const uint, const int);
void fillSquareCoord(const Coord, const uint);
void fillSquareCoordResize(const Coord, const uint, const int);
void fillBorder(uint, uint, uint, uint, int);
void fillBorderCoords(const Coord, const Length, const int);
void fillBorderCoordSquare(const Coord, const uint, const int);
void drawCircle(const uint, const uint, const uint);
void fillCircle(const uint, const uint, const uint);
void drawCircleCoord(const Coord, const uint);
void fillCircleCoord(const Coord, const uint);
Color getColor(void);
